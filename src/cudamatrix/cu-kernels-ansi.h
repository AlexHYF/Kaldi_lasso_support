...
void cudaD_lasso_col(const double *src,
                   double *dst, MatrixDim d);
void cudaF_lasso_col(const float *src, float *dst,
                   MatrixDim d);
void cudaD_lasso_row(const double *src,
                   double *dst, MatrixDim d);
void cudaF_lasso_row(const float *src, float *dst,
                   MatrixDim d);
